            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <Link v-if="$page.props.auth.user.is_super_admin" :href="route('admin.hall.edit')" class="flex items-center p-4 bg-white dark:bg-gray-800 border border-transparent rounded-xl shadow-sm hover:shadow-md hover:border-gray-300 dark:hover:border-gray-600 transition-all cursor-pointer">
